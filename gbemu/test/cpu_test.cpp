...
class CPUTest : public testing::Test {
 protected:
    ...
    void runProgramAndCompareRegistersAndRam(const Program& program, const ExpectedCPUs& expectedCPUs, bool includePC = false)
    {
        ASSERT_EQ(program.size(), expectedCPUs.size()) << "Length of expectedCPUs must equal number of instructions in program.";
...
TEST_F(CPUTest, OpcodeTest_0x00_NOP) {
    runProgramAndCompareRegistersAndRam(
        Program(4, {0x00}),              // DO 4 NOPs.
...
TEST_F(CPUTest, OpcodeTest_0x04_INC_B) {
    ...
    expectedCPUs[6]->setFlags(expectedCPUs[5]->FlagZ(), expectedCPUs[5]->FlagN(), expectedCPUs[5]->FlagH(), expectedCPUs[5]->FlagC());
...
TEST_F(CPUTest, OpcodeTest_0x29_ADD_HL_HL) {
    ...
    expectedCPUs[7]->setHL(0x8000);
    expectedCPUs[7]->setFlags(expectedCPUs[6]->FlagZ(), expectedCPUs[6]->FlagN(), expectedCPUs[6]->FlagH(), expectedCPUs[6]->FlagC());
