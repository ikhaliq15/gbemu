...
namespace gbemu {
    ...
    enum class Register { A, B, C, D, E, H, L };
    enum class FullRegister { BC, DE, HL, AF };
    enum class SpecialRegister { SP };
    ...
    const std::unordered_map<std::string, Operand> OPERANDS{
        {"A", Register::A}, {"B", Register::B}, {"C", Register::C}, {"D", Register::D}, {"E", Register::E}, {"H", Register::H}, {"L", Register::L},
        {"BC", FullRegister::BC}, {"DE", FullRegister::DE}, {"HL", FullRegister::HL}, {"AF", FullRegister::AF},
