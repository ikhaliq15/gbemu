...
namespace gbemu {
    ...
    private:
        ...
        const std::map<SDL_Keycode, uint8_t> BUTTON_TO_BIT_MAP = {
            {START_BUTTON, START_BUTTON_BIT},
            {SELECT_BUTTON, SELECT_BUTTON_BIT},
            {B_BUTTON, B_BUTTON_BIT},
            {A_BUTTON, A_BUTTON_BIT},
            {DOWN_BUTTON, DOWN_BUTTON_BIT},
            {UP_BUTTON, UP_BUTTON_BIT},
